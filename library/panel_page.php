  ...
  if (current_user_can('manage_options')) {
		  ...
		  <div class="tablenav">
			  <div class="alignleft actions">
				  <select name="action_key">
					  ...
					  <option value="export-selected"><?php _e('Export'); ?></option>
      ...
      if (current_user_can('install_plugins')) {
        ?>
		    ...
		    <p><?php _e("PHP Files can be uploaded and managed with the Theme Options Plugin."); ?></p>
...
?&gt;<?php }
    ...
    echo '<p>';
    _e('Only people that can manage options can access the content on this page.');
    echo '</p>';
  }
  echo '</div>';
