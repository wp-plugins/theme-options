...
?>
  <h3><?php _e('Edit Color'); ?></h3>
  <table class="form-table">
    <tbody>
    <tr valign="top">
      <th scope="row"><label for="editcolor">Color</label></th>
      <td><input type="text" class="medium-text" value="<?php echo (isset($fail)) ? $_POST['editcolor'] : $color; ?>" name="editcolor"/></td>
    </tr>
    <tr valign="top">
      <th scope="row"><label for="editname">Name</label></th>
  ...
  <input type="submit" name="Submit" value="<?php _e('Edit Color') ?>" />
  </p>
<?php
}
else {
?>
  <h3><?php _e('Add Color'); ?></h3>
  <table class="form-table">
    <tbody>
    <tr valign="top">
      <th scope="row"><label for="newcolor">Color</label></th>
      <td><input type="text" class="medium-text" value="<?php if (!isset($add_group_error)) echo $_POST['newcolor']; ?>" name="newcolor"/></td>
    </tr>
    <tr valign="top">
      <th scope="row"><label for="newname">Name</label></th>
  ...
  <input type="submit" name="Submit" value="<?php _e('Add Color', 'mt_trans_domain' ) ?>" />
  </p>
<?php
...
function color_management_post() {
  ...
  if (isset($_GET['page']) && $_GET['page'] == 'color_management_page' && isset($_REQUEST['action'])) { 
    $table_name = "theme_options_colors";
...
?>
  <div class='tablenav'>
    <div class='alignleft'>
      ...
      <select name="author">
        <option value="0" selected="selected">Show all Authors</option>
        <?php
  ...
  <table class='widefat'>
    ...
    <tbody>
      ...
      if ($type == 'inserter') {
        ...
        echo "</td>";
        echo "<td><strong>Inherit</strong></td>";
        echo "<td>Default</td>";
        echo "<td>&nbsp;</td>";
        echo "</tr>";
      }
